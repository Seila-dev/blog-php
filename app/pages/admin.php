...
<head>
  ...
  <title>Admin Controls - <?= APP_NAME ?></title>
  <link href="<?= ROOT ?>/public/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
  <link href="<?= ROOT ?>/public/assets/bootstrap-examples/bootstrap-5.3.8-examples/dashboard/dashboard.css" rel="stylesheet" />
  <style>
    .bd-placeholder-img {
      font-size: 1.125rem;
      text-anchor: middle;
...
<body>
        ...
        <div
          ...
          <div
            ...
            <ul class="nav flex-column mb-auto">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="<?= ROOT ?>/app/pages/logout">
                  <svg class="bi" aria-hidden="true">
  ...
  <script
    src="<?= ROOT ?>/public/assets/bootstrap/js/bootstrap.bundle.min.js"></script>
